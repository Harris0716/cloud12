...
function post_info(req, res){
    const {user_id,username,birthdate,education,residence,license,introduction,phone} = req.body;
    add_user_resume(user_id,username,birthdate,education,residence,license,introduction,phone).then((result)=>{
...
function put_info(req, res){
    ...
    update_user_resume(user_id,username,birthdate,education,residence,license,introduction,phone).then((result)=>{
